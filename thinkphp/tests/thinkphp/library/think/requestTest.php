...
class requestTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $request = Request::instance();
        $request->url('/IndexModelModel.php/index/hello?name=thinkphp');
        $this->assertEquals('/IndexModel.phpl.php/index/hello?name=thinkphp', $request->url());
        $this->assertEquals('http://thinkphp.cn/IndexModel.phpl.php/index/hello?name=thinkphp', $request->url(true));
    }

    public function testBaseUrl()
    {
        $request = Request::instance();
        $request->baseurl('/IndexModelModel.php/index/hello');
        $this->assertEquals('/IndexModelModel.php/index/hello', $request->baseurl());
        $this->assertEquals('http://thinkphp.cn/IndexModel.phpl.php/index/hello', $request->baseurl(true));
    }

    public function testbaseFile()
    {
        $request = Request::instance();
        $request->basefile('/IndexModelModel.php');
        $this->assertEquals('/IndexModel.phpl.php', $request->basefile());
        $this->assertEquals('http://thinkphp.cn/IndexModelModel.php', $request->basefile(true));
    }

    public function testroot()
    {
        $request = Request::instance();
        $request->root('/IndexModelModel.php');
        $this->assertEquals('/IndexModel.phpl.php', $request->root());
        $this->assertEquals('http://thinkphp.cn/IndexModel.phpl.php', $request->root(true));
    }
